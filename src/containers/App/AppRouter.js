    ...
    render() {
        ...
        return (
            <Switch>
                <Route
                    exact
                    path={`${url}/createVacansy`}
                    component={asyncComponent(() => import('../HRVacansy/CreateVacansy'))}
                />
                <Route
                    exact
                    path={`${url}/showEmployerResponse`}
                    component={asyncComponent(() => import('../HRVacansy/showResponse'))}
                />
                <Route
                    exact
                    path={`${url}/formEmployers`}
                    component={asyncComponent(() => import('../HRVacansy/Employers'))}
                />
                <Route
                    exact
                    path={`${url}/myForms`}
                    component={asyncComponent(() => import('../HRVacansy/MyForms'))}
                />
                <Route
                    exact
                    path={`${url}/`}
